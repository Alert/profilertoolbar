...
<style type="text/css">
  ...
  #ptb table td{padding:1px 5px; text-align: left; vertical-align: top; border: 1px dotted <?=$C_4;?>;}
  ...
  #ptb table td.graph div.line{background-color: <?=$C_2;?>; width: 0; height: 2px; float: right;}
  #ptb table td.graph div.val{padding: 1px 5px;}
  #ptb table.centr td{text-align: center;}
  #ptb_toolbar{position: fixed; top:0; right:0; z-index: 100501; border: 1px solid <?=$C_1;?>; border-top: none; border-radius: 0 0 0 5px; color: <?=$C_3;?>; padding: 2px 0; list-style: none;}
  ...
  #ptb_toolbar li span.total{color:<?=$C_1;?>;}
  ...
  #ptb_toolbar li.show {border: none;}
  #ptb_toolbar li.show     span.icon{background-position: -176px 0;}
  #ptb_toolbar li{float: left; border-left: 1px solid <?=$C_1;?>; padding: 2px 4px; margin: 0; cursor: pointer;}
  #ptb_toolbar li img{margin-right: 2px;}
  #ptb_toolbar li:first-child{border:none;}
  #ptb_data{position: absolute; top:0; left: 0; width: 100%; border-bottom: 1px solid gray; padding:0; margin-top: -1px; z-index: 100499; color:<?=$C_1;?>;}
  #ptb_data .ptb_data_cont{display: none; margin-top: 6px;}
  #ptb_data ul.ptb_tabs{list-style: none; margin: 0 0 -1px 15px; padding:0; overflow: hidden; font-size: 8pt; color: <?=$C_TABS;?>;}
  #ptb_data ul.ptb_tabs span{color:<?=$C_TABS_COUNT;?>;}
  #ptb_data ul.ptb_tabs li{border: 1px solid <?=$C_TABS_BORDER;?>; float: left; margin:0 3px; padding: 2px 3px; cursor: pointer; border-radius: 5px 5px 0 0;}
  #ptb_data ul.ptb_tabs li.use{border-bottom: 1px solid <?=$C_TABS_BORDER_USE;?>; color:white;}
  #ptb_data .ptb_tab_cont {border-top: 1px solid <?=$C_TABS_BORDER;?>; display: none; margin-bottom: 10px;}
  #ptb_data a.explain{border-bottom:1px solid <?=$C_4;?>; font-size: 8pt; color:<?=$C_4;?>; text-decoration: none;}
</style>